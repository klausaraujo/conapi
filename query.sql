...
CREATE TABLE modulo  (
  ...
  PRIMARY KEY (idmodulo)) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;
	...
	INSERT INTO modulo (idmodulo,descripcion,menu,icono,url,imagen,mini,orden) VALUES (2,'Módulo de Registro de Afiliaciones','Módulo Afiliaciones','afiliaciones.png','afiliaciones','1','fa fa-id-card',2);
...
CREATE TABLE permiso  (
  ...
  PRIMARY KEY (idpermiso),
	...
	INSERT INTO permiso(idpermiso,descripcion,tipo,orden,idmodulo) VALUES(5,'Editar Afiliado','1',5,2);
...
CREATE TABLE menu  (
  ...
  PRIMARY KEY (idmenu),
	...
	INSERT INTO menu(idmenu,idmodulo,descripcion,nivel,url,icono) VALUES(3,2,'Lista Afiliados','0','afiliaciones','fa fa-list');
	INSERT INTO menu(idmenu,idmodulo,descripcion,nivel,url,icono) VALUES(4,2,'Nuevo Registro','0','nuevafiliacion','fa fa-pencil-square-o');
...
CREATE TABLE menu_detalle  (
  ...
  PRIMARY KEY (idmenudetalle),
	...
	INSERT INTO menu_detalle (idmenudetalle,idmenu,descripcion,url,icono,orden) VALUES(1,2,'Reporte Afiliados','#','fa fa-th-list',1);
...
idafiliado smallint(4) NOT NULL AUTO_INCREMENT,
idtipodocumento smallint(4) NOT NULL,
numero_documento varchar(10) NOT NULL,
...
latitud varchar(25),
longitud varchar(25),
colmenas smallint(4) default 0,
nucleos smallint(4) default 0,
socio char(1) default '1',

raza_carniola char(1) default '0',
raza_africanizada char(1) default '0',
raza_italiana char(1) default '0',
raza_hibrida char(1) default '0',
raza_criolla char(1) default '0',
raza_buckfast char(1) default '0',
raza_otras char(1) default '0',
raza_otras_detalle varchar(100),
